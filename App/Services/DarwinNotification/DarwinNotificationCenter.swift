...
//  CookieCleaner
//
//  Created by Sufiyan Yasa on 01/11/2021.
//
...
public final class DarwinNotificationCenter {
  ...
  private let queue = DispatchQueue(label: "com.xr1337.CookieCleaner.-darwin-notificationcenter", qos: .default, attributes: [], autoreleaseFrequency: .workItem)
